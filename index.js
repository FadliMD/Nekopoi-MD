...
function title() {
	  console.log(chalk.bold.blue(figlet.textSync('Nekopoi-MD', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n ${chalk.blue('[ Created By ZyrexxOfc ]')}\n`))
}
/**
...
const connectToWhatsApp = async () => {
	const conn = makeWASocket({
            ...
            auth: state,
            browser: ["Nekopoi-MD Multi Device", "Safari", "1.0"]
        })
	title()
        store.bind(conn.ev)
	...
	nocache('./index.js', module => console.log(chalk.yellow(`'./index.js' Telah diupdate`)))
